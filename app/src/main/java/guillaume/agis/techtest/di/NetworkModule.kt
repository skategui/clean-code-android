...
class NetworkModule {
    ...
    @Provides
    fun createPostResource(retrofit: Retrofit): PostResource = retrofit.create(PostResource::class.java)

    @Provides
    fun createUserResource(retrofit: Retrofit): UserResource = retrofit.create(UserResource::class.java)
